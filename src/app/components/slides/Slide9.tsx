...
export function Slide9() {
  ...
  return (
    <div className="relative w-full h-full bg-[#121212] overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-16 flex flex-col justify-center h-full">
        <motion.div
        ...
        >
          ...
          <h2 className="font-mono text-[#cc5500] text-xl tracking-[0.2em] uppercase text-glow-orange">
              ...
              <div className="space-y-6">
                {cat.items.map((item, j) => (
                  ...
                  >
                    ...
                    <p className="font-mono text-[#8e8e8e] group-hover/item:text-white text-[15px] tracking-widest uppercase transition-colors whitespace-pre-line leading-relaxed">
